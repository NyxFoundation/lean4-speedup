...
| **Async kernel processing for inductives** (experimental patch, module system included) — mechanism validated; corpus numbers retracted pending re-validation (a measurement-harness flaw hid per-module failures; the built-in drift failsafe caught a field-default eligibility bug) | [docs/benchmarks.md §8](docs/benchmarks.md), [docs/t2c-async-inductives.md](docs/t2c-async-inductives.md) |
